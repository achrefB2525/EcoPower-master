...
public class SecrityConfig   {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers("/checkout/**").hasAnyAuthority(Role.Provider.name() ,Role.User.name(),Role.Admin.name())
                .antMatchers("/addProduct/**").hasAnyAuthority(Role.Provider.name(),Role.Admin.name())
                .antMatchers("/addCategory/**").hasAnyAuthority(Role.Provider.name(),Role.Admin.name())
                .antMatchers("/listProduct/**").hasAnyAuthority(Role.Provider.name(),Role.Admin.name())
                .antMatchers("/listCategory/**").hasAnyAuthority(Role.Provider.name(),Role.Admin.name())
                .antMatchers("/products/**").hasAnyAuthority(Role.User.name())
                .antMatchers("/cart/**").hasAnyAuthority(Role.User.name())
